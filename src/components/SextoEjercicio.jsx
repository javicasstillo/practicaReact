...
function SextoEjercicio() {
    ...
    const obtenerNoticia = async (e) => {
        ...
        if (extraerDatos.status === 200) {
            ...
            if(resultadoNoticia.results.length>0){
                setNoticia(resultadoNoticia.results)
                setMensaje("") //noticias encontradas
            } else {
                setNoticia([])
                setMensaje("No hay noticias en este momento para la categoria del pais que marcaste.")
            } 
    ...
    return <div className="text-center py-3">
        ...
        <div className="container d-flex justify-content-center">
            <form className="d-flex flex-column w-75 justify-content-center gap-3">
